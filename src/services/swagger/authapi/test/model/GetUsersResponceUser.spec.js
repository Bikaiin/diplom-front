...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetUsersResponceUser', function() {
      beforeEach(function() {
        instance = new Serviceserviceproto.GetUsersResponceUser();
      });

      it('should create an instance of GetUsersResponceUser', function() {
        // TODO: update the code to test GetUsersResponceUser
        expect(instance).to.be.a(Serviceserviceproto.GetUsersResponceUser);
      });
