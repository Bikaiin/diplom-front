...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthApiRefreshRequest', function() {
      beforeEach(function() {
        instance = new Serviceserviceproto.AuthApiRefreshRequest();
      });

      it('should create an instance of AuthApiRefreshRequest', function() {
        // TODO: update the code to test AuthApiRefreshRequest
        expect(instance).to.be.a(Serviceserviceproto.AuthApiRefreshRequest);
      });
