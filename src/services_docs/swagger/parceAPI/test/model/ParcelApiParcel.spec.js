...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ParcelApiParcel', function() {
      beforeEach(function() {
        instance = new Serviceserviceproto.ParcelApiParcel();
      });

      it('should create an instance of ParcelApiParcel', function() {
        // TODO: update the code to test ParcelApiParcel
        expect(instance).to.be.a(Serviceserviceproto.ParcelApiParcel);
      });
